/* @ts-self-types="./anime4k_wgpu_rs.d.ts" */
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_anime4kprocessor_new: function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('anime4k_wgpu_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
